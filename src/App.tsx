...
type Artwork = {
  id: number
  subject: 'Visual Arts' | 'Music' | 'Theatre' | 'Dance'
  title: string
  artist: string
  year: string
  type: string
...
const ARTWORKS: Artwork[] = [
  ...
  },
  {
    ...
    analysis: {
      context: 'Post-WWII existential crisis. Reflects the meaninglessness of time and action.',
      elements:
  ...
  },
  {
    ...
    analysis: {
      context: 'Baroque era. Elevation of the cello from accompaniment to solo voice.',
      elements:
  ...
  },
  {
    ...
    analysis: {
      context: 'Black Lives Matter era. Exploration of fame, depression, and heritage.',
      elements:
  ...
  },
  {
    ...
    analysis: {
      context: 'Israel. Compilation of Naharin\'s works. Gaga promotes listening to the body.',
      elements:
...
const EmbossedLabel: React.FC<{ text: string }> = ({ text }) => (
  <span
    className="
...
const AnalysisModal: React.FC<{ artwork: Artwork | null; onClose: () => void }> = ({ artwork, onClose }) => {
        ...
        <div className="h-12 bg-amber-100 border-b border-amber-200 flex items-center px-6 justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="font-mono text-amber-800 text-sm uppercase tracking-widest font-bold">
              CONFIDENTIAL // IB ANALYSIS RECORD // {artwork.id.toString().padStart(3, '0')}
            </span>
          </div>
          <button onClick={onClose} className="text-amber-800 hover:text-red-600 transition-colors">
            <X className="w-6 h-6" />
          </button>
        </div>

        <div className="p-8 md:p-12 overflow-y-auto custom-scrollbar bg-[url('https://www.transparenttextures.com/patterns/cream-paper.png')]"><div className="flex justify-between items-start mb-8 border-b-2 border-slate-200 pb-6">
            <div>
              <h2 className="text-4xl md:text-5xl font-serif text-slate-800 mb-2">{artwork.title}</h2>
            ...
            <div className="hidden md:block text-right">
              ...
              <p className="text-[10px] text-slate-400 font-mono uppercase">Rights: {artwork.rightsHolder}</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-slate-700">
            <div className="md:col-span-1 space-y-4">
              ...
              <p className="leading-relaxed text-sm md:text-base">{artwork.analysis.context}</p>
            </div>
            ...
            <div className="md:col-span-1 space-y-4">
              ...
              <p className="leading-relaxed text-sm md:text-base">{artwork.analysis.elements}</p>
            </div>
            ...
            <div className="md:col-span-1 space-y-4">
              ...
              <p className="leading-relaxed text-sm md:text-base font-medium">{artwork.analysis.significance}</p>
            </div>
          </div>
          ...
          <div className="mt-12 pt-6 border-t border-slate-200 text-xs font-mono text-slate-400 flex flex-col md:flex-row justify-between gap-2">
            <span>
              REF: {artwork.subject.toUpperCase()} / {artwork.type.toUpperCase()}
            </span>
      ...
      <div className="relative w-full max-w-5xl bg-[#f8f9fa] rounded-2xl shadow-[20px_20px_60px_#bebebe,-20px_-20px_60px_#ffffff] transform transition-all duration-300 animate-in zoom-in-95 border border-white/50 overflow-hidden flex flex-col max-h-[90vh]">
        <div className="h-16 bg-gradient-to-r from-slate-200 to-slate-100 border-b border-white/60 flex items-center px-6 justify-between shadow-sm z-20 shrink-0">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="font-bold text-slate-700 text-lg leading-none">Arnav Ajana</h3>
              <span className="text-xs font-mono text-slate-500 uppercase tracking-widest">Creator &amp; MYP 5 Student</span>
            </div>
          </div>
          <button
            type="button"
        ...
        <div className="overflow-y-auto custom-scrollbar bg-[url('https://www.transparenttextures.com/patterns/graphy.png')] bg-fixed">
            ...
            <div className="flex flex-col md:flex-row gap-10 items-start">
              <div className="w-full md:w-1/3 shrink-0">
                <div className="relative aspect-[3/4] w-full rounded-2xl overflow-hidden border-8 border-white shadow-xl rotate-[-2deg] hover:rotate-0 transition-transform duration-500">
                  ...
                  <div className="absolute bottom-0 inset-x-0 bg-gradient-to-t from-black/60 to-transparent p-4">
                    <p className="text-white font-mono text-xs uppercase tracking-widest">Gurgaon, India</p>
                  </div>
                </div>
              </div>
              ...
              <div className="w-full md:w-2/3 pt-4">
                <h2 className="text-4xl md:text-5xl font-black text-slate-800 mb-6 leading-tight">
                  Breaking Norms <br />
                  <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-blue-600">Through Movement</span>
                </h2>

                <div className="prose prose-slate text-justify max-w-none">
                  <p className="text-slate-600 text-lg leading-relaxed font-medium mb-4">
                    I am an Indian dancer based in Gurgaon, redefining what it means to be a performer in the 21st century. My artistic
                    practice is a deliberate collision of worlds—spanning the rigorous, gravity-defying discipline of <strong>Ballet</strong>, the expressive improvisational freedom of <strong>Jazz and Contemporary</strong>, the raw,
                    rhythmic energy of <strong>Hip-Hop and Commercial</strong>, and the ancient, martial intensity of <strong>Chhau</strong>.
                  </p>
                  <p className="text-slate-600 text-lg leading-relaxed font-medium mb-4">
                    Growing up in a culture rich with tradition, I chose not to be confined by a single label. Embracing these diverse forms allows me to break cultural norms and challenge the expected narrative of what an “Indian dancer” looks like. It is a balancing act between the precision of the West and the grounded power of the East. My work explores how these seemingly opposing forces can coexist within a single body, creating a movement language that is uniquely my own.
                  </p>
                  <p className="text-slate-600 text-lg leading-relaxed font-medium">
                    My journey is proof that when you refuse to be categorized, you don't just participate—you win. I created <strong>IB E-Source</strong> because I know the struggle of finding resources that speak to this level of depth. This platform is my way of empowering other students to find the knowledge they need to break their own boundaries and define their own stages.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="p-8 md:p-12">
            <div className="flex items-center gap-4 mb-10">
              ...
              <h4 className="text-xl font-bold text-slate-400 uppercase tracking-widest">My Journey to the Stage</h4>
              <div className="h-px bg-slate-300 flex-grow" />
            </div>
              ...
              <div className="relative group">
                ...
                <div className="bg-white p-8 rounded-2xl border border-slate-100 shadow-lg hover:shadow-xl transition-shadow relative overflow-hidden">
                  ...
                  <div className="flex items-center gap-2 mb-3">
                    <span className="text-xs font-bold text-purple-600 uppercase bg-purple-100 px-2 py-1 rounded">The Foundation</span>
                  </div>
                  <h5 className="font-bold text-slate-800 text-2xl mb-3">Where It Started</h5>
                  <p className="text-slate-600 leading-relaxed">
                    My journey began in school, where I discovered my passion for dance. I mastered the stage by winning multiple Intra and Inter-school competitions, performing in solos, duets, and groups.
                  </p>
                </div>
              </div>
              ...
              <div className="relative group">
                ...
                <div className="bg-white p-8 rounded-2xl border border-slate-100 shadow-lg hover:shadow-xl transition-shadow relative overflow-hidden">
                  ...
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <span className="text-xs font-bold text-blue-500 uppercase tracking-wide">Gwalior, India</span>
                  </div>
                  <h5 className="font-bold text-slate-800 text-2xl mb-4">My National Championship</h5>
                  <p className="text-slate-600 mb-6">I took my skills to the national level in Gwalior, where I competed against the best in the country.</p>
                  <div className="space-y-3 bg-slate-50 p-4 rounded-xl border border-slate-200">
                    <div className="flex items-center justify-between text-sm">
                      <span className="font-medium text-slate-700">Folk Group</span>
                      <span className="font-bold text-blue-600 bg-blue-50 px-2 py-0.5 rounded border border-blue-100">1st Place 🥇</span>
                    </div>
                    <div className="h-px bg-slate-200 w-full" />
                    <div className="flex items-center justify-between text-sm">
                      <span className="font-medium text-slate-700">Semi-classical Solo</span>
                      <span className="font-bold text-blue-600 bg-blue-50 px-2 py-0.5 rounded border border-blue-100">1st Place 🥇</span>
                    </div>
                    <div className="h-px bg-slate-200 w-full" />
                    <div className="flex items-center justify-between text-sm">
                      <span className="font-medium text-slate-700">Semi-classical Group</span>
                      <span className="font-bold text-slate-500 bg-slate-100 px-2 py-0.5 rounded border border-slate-200">3rd Place 🥉</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="relative group">
                ...
                <div className="bg-gradient-to-br from-amber-50 to-orange-50 p-8 rounded-2xl border border-amber-100 shadow-xl hover:shadow-2xl transition-all transform hover:-translate-y-1 relative overflow-hidden">
                  ...
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <span className="text-xs font-bold text-amber-600 uppercase tracking-wide">Nessebar, Bulgaria</span>
                  </div>
                  <h5 className="font-bold text-slate-800 text-2xl mb-3">Representing India</h5>
                  <p className="text-slate-700 mb-6 leading-relaxed">
                    I had the honor of representing my country internationally at the <strong>"Sun, Joy and Beauty" Festival</strong>.
                  </p>
              ...
              <div className="relative group">
                ...
                <div className="bg-slate-50/50 backdrop-blur-sm p-8 rounded-2xl border border-slate-200 border-dashed">
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <span className="text-xs font-bold text-slate-400 uppercase tracking-wide">Next Mission</span>
                  </div>
                  <h5 className="font-bold text-slate-600 text-2xl mb-2">Upcoming International Solo</h5>
                  <p className="text-slate-500 italic">
                    I am currently training to represent India once again on the global stage with a new solo performance.
                  </p>
                </div>
              </div>
            </div>
...
export default function App() {
  const [activeSubject, setActiveSubject] = useState<Subject['name']>('All')
    ...
    () =>
      ARTWORKS.filter((res) => {
        ...
        const matchesSearch =
          ...
          res.artist.toLowerCase().includes(query) ||
  ...
  return (
    <div className="min-h-screen bg-[#e0e5ec] text-slate-700 font-sans selection:bg-purple-200 overflow-x-hidden relative">
      <div
        ...
        style={{ backgroundImage: 'radial-gradient(#a3aab8 1px, transparent 1px)', backgroundSize: '24px 24px' }}
      />
      ...
      <section className="relative min-h-[90vh] flex flex-col items-center justify-center z-10 p-6">
        <div
          ...
          style={{
            transform: `translateY(${scrolled * 0.5}px) scale(${1 - scrolled * 0.0005})`,
        ...
        >
          ...
          <GlassCard className="px-12 py-16 text-center relative overflow-hidden">
            <h1 className="text-6xl md:text-8xl font-black tracking-tighter text-slate-800 mb-2">
              IB <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-blue-600">E-Source</span>
            </h1>
            <p className="text-xl font-light text-slate-500 tracking-widest uppercase">The Digital Atelier for Arts</p>
          </GlassCard>
        </div>

        <div className="absolute bottom-10 animate-bounce transition-opacity duration-300" style={{ opacity: scrolled > 100 ? 0 : 1 }}>
        ...
        <div className="sticky top-6 z-50 mb-16">
          <div className="bg-[#e0e5ec]/80 backdrop-blur-lg rounded-3xl p-4 shadow-[8px_8px_16px_#b8b9be,-8px_-8px_16px_#ffffff] border border-white/40 flex flex-col md:flex-row justify-between items-center gap-6">
            <div className="flex flex-wrap justify-center gap-3">
              {SUBJECTS.map((sub) => (
                <NeuButton key={sub.name} isActive={activeSubject === sub.name} onClick={() => setActiveSubject(sub.name)}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
          {filteredResources.length === 0 ? (
            <div className="col-span-full flex flex-col items-center justify-center py-24 opacity-40">
              ...
              <p className="text-2xl font-light">No works found in the archive.</p>
            </div>
          ) : (
              ...
              >
                ...
                <GlassCard className="h-full flex flex-col hover:-translate-y-2 transition-transform duration-500 hover:shadow-[0_20px_40px_rgba(0,0,0,0.1)] group-hover:border-white/90">
                  ...
                  <div className="mb-2">
                    ...
                    <p className="text-sm font-bold text-slate-500 mt-1 uppercase tracking-wide">{res.artist}</p>
                    <p className="text-xs text-slate-400 italic mt-1">{res.type}</p>
                  </div>
      ...
      <footer className="relative z-10 mt-10 py-16 text-center px-4">
        <div className="flex flex-col md:flex-row items-center justify-center gap-6 max-w-4xl mx-auto">
          <div className="flex-1 p-6 rounded-2xl shadow-[inset_5px_5px_10px_#bebebe,inset_-5px_-5px_10px_#ffffff] bg-[#e0e5ec] text-left">
            <p className="text-slate-600 font-bold text-xs uppercase tracking-wide mb-2">Legal Disclaimer</p>
            <p className="text-slate-500 text-[10px] leading-relaxed">
              IB E-Source does not claim ownership of any artworks listed. All intellectual property belongs to their respective copyright holders. This database is for academic analysis only.
            </p>
          </div>

          <div className="flex-shrink-0">
            <NeuButton onClick={() => setShowCreator(true)} className="!px-8 !py-4 flex items-center gap-3">
              <User className="w-5 h-5 text-purple-600" />
              <span className="text-sm font-bold text-slate-600">About the Creator</span>
            </NeuButton>
          </div>
        </div>
      </footer>

      {selectedArtwork && <AnalysisModal artwork={selectedArtwork} onClose={() => setSelectedArtwork(null)} />}
